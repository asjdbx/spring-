 ...
 * @LastEditTime: 2026-05-10 10:16:40
    ...
    <el-card class="page-container">
        <template #header>
            <div class="header">
                <span> </span>
                <div class="extra">
                    <el-button type="primary" @click="visibleDrawer = true; title='';  clearData()">添加文章</el-button>
                </div>
            </div>
        </template>
        <!-- 搜索表单 -->
        ...
        <el-table :data="articles" style="width: 100%">
            ...
            <el-table-column label="操作" width="100">
                <template #default="{ row }">
                    ...
                    <el-button :icon="Delete" circle plain type="danger"@click="delterArticle(row)"></el-button>
                </template>
            </el-table-column>
            <template #empty>
        ...
        <el-drawer v-model="visibleDrawer" :title="title" direction="rtl" size="50%">
            ...
            <el-form :model="articleModel" label-width="100px">
                ...
                <el-form-item label="文章内容">
                   ...
                   <!-- 修改表单内的两个按钮 -->
<el-form-item>
    <el-button type="primary" plain @click="selectedState = '已发布'">发布</el-button>
    <el-button type="info" plain @click="selectedState = '草稿'">草稿</el-button>
    <span v-if="selectedState" style="margin-left: 10px; color: #409eff;">
        当前选择：{{ selectedState }}
    </span>
</el-form-item>
            </el-form>
             <template #footer>
                <span class="dialog-footer">
                    ...
                    <el-button type="primary" @click="title == '添加文章' ? addArticle() : updateArticle()"> 确认 </el-button>
                </span>
            </template>
        </el-drawer>
    </el-card>
...
const addArticle = async () => {
    ...
    if (!selectedState.value) {
        ElMessage.warning('请先点击"发布"或"草稿"按钮选择状态');
        return;
    }
    
    articleModel.value.state = selectedState.value;
...
const updateArticle = async ()=>{ 
    // console.log(2+articleModel.value);
       if (selectedState.value) {
        articleModel.value.state = selectedState.value;
    }
...
const delterArticle = async (row)=>{ 
    console.log(row);
 // 弹出确认对话框
  ElMessageBox.confirm(
    '确定要删除文章信息？',  // 对话框内容（提示文本）
    '提示',  // 对话框标题
    { 
